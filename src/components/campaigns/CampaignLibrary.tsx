...
export const CampaignLibrary: React.FC<CampaignLibraryProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-subtle flex flex-wrap items-center justify-between gap-4">
        <div className="relative flex-1 min-w-[280px]">
          ...
          <input
            ...
            placeholder="Search campaigns by property address, title, or target metro..."
            className="w-full pl-10 pr-4 py-2.5 text-xs sm:text-sm border border-slate-200 rounded-xl focus:ring-2 focus:ring-slate-900 bg-slate-50 focus:bg-white transition-colors"
          />
        </div>
